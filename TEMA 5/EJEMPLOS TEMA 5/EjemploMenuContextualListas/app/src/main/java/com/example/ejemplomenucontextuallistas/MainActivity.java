...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        // Compruebo el elemento pulsado para ver que menú inflo
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.mcOp1 ||id == R.id.mcOp2 ||id == R.id.mcOp3 ||id == R.id.mn2Op1) {
            texto = item.getTitle().toString();
            Toast.makeText(this, texto, Toast.LENGTH_SHORT).show();
        }

        // Obtengo la información del elemento sobre el que hemos desplegado el menú
